...
public class GUIMST extends JFrame {
	...
	private JPanel jPanelMatriksKetetanggaan = null;
	...
	private JTabbedPane getJTabbedPane1() {
		if (jTabbedPane1 == null) {
			...
			jTabbedPane1.addTab("Matriks Ketetanggaan", null, getJPanelMatriksKetetanggaan(), null);
	...
	/**
	 * This method initializes jPanelMatriksKetetanggaan	
	 * 	
	 * @return javax.swing.JPanel	
	 */
	private JPanel getJPanelMatriksKetetanggaan() {
		if (jPanelMatriksKetetanggaan == null) {
			jPanelMatriksKetetanggaan = new JPanel();
			jPanelMatriksKetetanggaan.setLayout(new BorderLayout());
			jPanelMatriksKetetanggaan.add(getJScrollPane(), BorderLayout.CENTER);
		}
		return jPanelMatriksKetetanggaan;
	}
	...
	*/
	...
	private JScrollPane getJScrollPane() {
		if (jScrollPane == null) {
			...
			jScrollPane.setViewportView(getJTableMatriksKetetanggaan());
		}
		return jScrollPane;
	}

	/**
	 * This method initializes jTableMatriksKetetanggaan	
	 * 	
	 * @return javax.swing.JTable	
	 */
	private JTable getJTableMatriksKetetanggaan() {
		if (jTableMatriksKetetanggaan == null) {
			jTableMatriksKetetanggaan = new JTable();
		}
		return jTableMatriksKetetanggaan;
	}
	...
	private JButton getJButtonExit() {
		if (jButtonExit == null) {
			...
			jButtonExit.setLocation(new Point(655, 306));
...
//////////////////////////////////////////////////////////////////////////////////
	...
	private JTable jTableMatriksKetetanggaan = null;
